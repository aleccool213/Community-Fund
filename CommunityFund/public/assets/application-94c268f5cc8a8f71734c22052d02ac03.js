...
;
(function() {
  var moderation, ready, settings;

  settings = function() {
    var removeBtnClickHandler, updateRemoveBtns;
    if (!$('body').hasClass('settings')) {
      return;
    }
    updateRemoveBtns = function() {
      if ($('.admin-user').length <= 1) {
        return $('.remove-admin-btn').prop('disabled', true);
      } else {
        return $('.remove-admin-btn').prop('disabled', false);
      }
    };
    updateRemoveBtns();
    removeBtnClickHandler = function() {
      $(this).closest('tr').remove();
      return updateRemoveBtns();
    };
    $('.remove-admin-btn').click(removeBtnClickHandler);
    $('.make-admin-btn').click(function() {
      var $lastrow, $newrow, username;
    ...
    return $('.save-changes-btn').click(function() {
      var usernames;
      usernames = $.map($('.admin-username'), function(v) {
        return $(v).text().trim();
      });
      return $.post('/admin/settings/update_admins', {
        'usernames': usernames
      });
    });
  };
  ...
  moderation = function() {
    var $dismiss_btn;
    if (!$('body').hasClass('moderation')) {
      return;
    }
    $dismiss_btn = $('.dismiss-btn');
    return $dismiss_btn.click(function() {
      var obj_id, obj_type, req_data;
      ...
      return $.ajax('/report/dismiss', req_data).success(function() {
        return $dismiss_btn.closest('tr').fadeOut();
      });
    });
  };
...
(function() {
  ...
  ready = function() {
    jQuery(function() {
      var all_ready, submit_show;
      submit_show = function() {
        $('#signup_button').show();
        return void 0;
      };
      all_ready = function() {
        var email, password, password_confirm, re, username;
        ...
        re = /\S+@\S+\.\S+/;
        if ((username.length > 5) && re.test(email) === true && (password.length > 7) && (password_confirm === password)) {
          return true;
        } else {
          return false;
        }
      };
      $('#signup-username-input').bind('input', (function() {
        var value;
        value = $(this).val();
        if (value.length > 5) {
          ...
          return $("#signup-username-icon").attr("class", "glyphicon glyphicon-remove form-control-feedback");
        }
      })).trigger('input');
      $('#signup-email-input').bind('input', (function() {
        var re, value;
        value = $(this).val();
        re = /\S+@\S+\.\S+/;
        if (re.test(value) === true) {
          ...
          return $("#signup-email-icon").attr("class", "glyphicon glyphicon-remove form-control-feedback");
        }
      })).trigger('input');
      $('#signup-password-input').bind('input', (function() {
        var value;
        value = $(this).val();
        if (value.length > 7) {
          ...
          return $("#signup-password-icon").attr("class", "glyphicon glyphicon-remove form-control-feedback");
        }
      })).trigger('input');
      return $('#signup-password-confirm-input').bind('input', (function() {
        var value;
        value = $(this).val();
        if ($('#signup-password-input').val() === value && value !== "") {
          ...
          return $("#signup-password-confirm-icon").attr("class", "glyphicon glyphicon-remove form-control-feedback");
        }
      })).trigger('input');
    });
    return jQuery(function() {
      ...
      $('#login-username-input').bind('input', (function() {
        var value;
        value = $(this).val();
        if (value.length > 5) {
          ...
          return $("#login-username-icon").attr("class", "glyphicon glyphicon-remove form-control-feedback");
        }
      })).trigger('input');
      $('#login-password-input').bind('input', (function() {
        var value;
        value = $(this).val();
        if (value.length > 7) {
          ...
          return $("#login-password-icon").attr("class", "glyphicon glyphicon-remove form-control-feedback");
        }
      })).trigger('input');
...
(function() {
  ...
  ready = function() {
    var $report_btn, $report_modal_btn;
    if (!$('body').hasClass('projects')) {
      return;
    }
    $report_btn = $('.report-btn');
    $report_modal_btn = $('.report-confirm-btn');
    return $report_modal_btn.click(function() {
      var proj_id, req_data;
      ...
      return $.ajax('/report/project', req_data).success(function() {
        return $report_btn.fadeOut();
      });
    });
  };
